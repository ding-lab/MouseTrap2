...
FQ1="/gscmnt/gc2508/dinglab/mwyczalk/MouseTrap2.data/FASTQ/hgmm_1.fastq.gz"
FQ2="/gscmnt/gc2508/dinglab/mwyczalk/MouseTrap2.data/FASTQ/hgmm_2.fastq.gz"
...
OUTDIR="/gscmnt/gc2508/dinglab/mwyczalk/MouseTrap2.data/results2"
mkdir -p $OUTDIR
LOGS="-e $OUTDIR/run.err -o $OUTDIR/run.out"

CMD="/bin/bash MouseTrap2.sh -1 $FQ1 -2 $FQ2 -h $HGFA -m $MMFA -o $OUTDIR -c"
